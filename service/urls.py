...
from .views import (
    register_view,login_view,home_view,product_page_view,cart_view,add_to_cart, remove_from_cart, update_cart_item, checkout_view, payment_done_view, payment_cancelled_view, paypal_checkout_view
)
