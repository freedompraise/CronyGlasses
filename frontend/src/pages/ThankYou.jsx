  ...
  return (
    <div className="bg-white p-4 sm:p-8 mx-auto max-w-6xl my-16">
      ...
      <div className="text-center">
        <h1 className="confirmation-heading text-2xl font-bold mb-4">
          Order Successful!
        </h1>
        ...
        <div className="flex flex-col mx-auto text-white w-1/5 mt-8 font-sans">
          <a
            className="bg-gray-800 text-white py-2 px-2/3 mb-2 sm:mb-1 rounded-lg overflow-hidden text-center hover:bg-black"
            href="/account"
          >
            {" "}
            <button className="">View Order Details</button>
          </a>
